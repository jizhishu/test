...
class ProductitemTest(unittest.TestCase):
    ...
    def setUp(self):
        self.connect = mongo_utility.MongoUtility(serverip='192.168.1.110', dbname='test1', collectionname='test1')
    ...
    def testsearchByCategory(self):
        categorylist = []
        categorylist.append('172607')
        print categorylist    
        productList = self.product.searchByCategory(categorylist)
...
def suite():  
    ...
    suite.addTest(ProductitemTest('testsearchByCategory'))
    return suite
